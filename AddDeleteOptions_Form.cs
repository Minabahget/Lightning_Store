...
{
    public partial class AddDeleteOptions_Form : Form
    {
        // make object from the mainfunctions 
        Main_Functions mf;
        public AddDeleteOptions_Form()
        {
            InitializeComponent();
        ...
        private void Add_Button_Click(object sender, EventArgs e)
        {
            ...
            mf.FormIsOpen("Categories_Add_Form", ref is_open);
            // in case the form is not open 
            if (!is_open)
            {
                // make object form the form we want to open 
                Categories_Add_Form IF = new Categories_Add_Form();
        ...
        private void Delete_Button_Click(object sender, EventArgs e)
        {
            ...
            bool is_open = false;
            // call this function to check if the form is opened or not 
            mf.FormIsOpen("Categories_Delete_Form", ref is_open);
            // in case the form is not open 
            if (!is_open)
            {
                // make object form the form we want to open 
                Categories_Delete_Form IF = new Categories_Delete_Form();
                // show the form we want to use 
                IF.Show();
                // make the new form on the top 
                IF.TopLevel = true;
        ...
        private void Add_Product_Button_Click(object sender, EventArgs e)
        {
            ...
            bool is_open = false;
            // call this function to check if the form is opened or not 
            mf.FormIsOpen("Products_Add_Form", ref is_open);
            // in case the form is not open 
            if (!is_open)
            {
                // make object form the form we want to open 
                Products_Add_Form IF = new Products_Add_Form();
                // show the form we want to use 
                IF.Show();
                // make the new form on the top 
                IF.TopLevel = true;
        ...
        private void Delete_Product_Button_Click(object sender, EventArgs e)
        {
            ...
            bool is_open = false;
            // call this function to check if the form is opened or not 
            mf.FormIsOpen("Products_Delete_Form", ref is_open);
            // in case the form is not open 
            if (!is_open)
            {
                // make object form the form we want to open 
                Products_Delete_Form IF = new Products_Delete_Form();
                // show the form we want to use 
                IF.Show();
                // make the new form on the top 
                IF.TopLevel = true;
